...
# Entorno DevOps: no inicializar base de datos aquí (se maneja por servicio principal)
logger.info("[INIT] ℹ️ Saltando init_db en DevOps (no requerido)")
...
if application:
    logger.info("[INIT] ✅ API DevOps inicializada correctamente")
