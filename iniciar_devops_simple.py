...
# -*- coding: utf-8 -*-
"""
Iniciar servicios DevOps sin emojis Unicode
"""
...
def esperar_servicios():
    ...
    print("\nESPERANDO SERVICIOS")
    print("=" * 50)
    print("Esperando 20 segundos para que los servicios se inicien...")
    time.sleep(20)
...
def main():
    """Función principal"""
    print("INICIO COMPLETO DE SERVICIOS DEVOPS")
    print("=" * 60)
    print("Iniciando todos los servicios y verificando funcionamiento")
    print("")
